'''
Django settings for sexybaby project.
...
SECRET_KEY = '4(@ih=e%$=7jefxi^(m@(rg_q65z^s1b)qbwr^b83qtxq2&70-'
...
MIDDLEWARE = [
    ...
    'sexybaby.accessLogs.AccessLogsMiddleware',
]

ROOT_URLCONF = 'sexybaby.urls'
